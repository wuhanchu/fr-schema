...
import { calcNodeScale } from "@/pages/flow/rx-models/graph-util"
import { useExperimentGraph } from "@/pages/flow/rx-models/experiment-graph"
import { NExperimentGraph } from "@/pages/flow/rx-models/typing"
import {
    X6DemoGroupNode,
    X6DemoNode,
} from "@/pages/flow/common/graph-common/shape/node"
            ...
            incomingEdges
                ...
                .forEach((edge) => {
                    ...
                    if (
                        ...
                        const parentNodePorts = sourceParentNode.getPortsByGroup(
                            "out"
                        )
            ...
            outgoingEdges
                ...
                .forEach((edge) => {
                    ...
                    if (
                        ...
                        const parentNodePorts = targetParentNode.getPortsByGroup(
                            "in"
                        )
