...
export const ContextMenu: React.FC<ContextMenuProps> = (props) => {
    ...
    switch (menuType) {
        case "edge":
            return (
                <EdgeContextMenu experimentId={experimentId} data={menuData} />
            )
        case "graph":
            return (
                <GraphContextMenu experimentId={experimentId} data={menuData} />
            )
        case "node":
            return (
                <NodeContextMenu experimentId={experimentId} data={menuData} />
            )
        default:
            return null
    }
...
export const FloatingContextMenu: React.FC<Props> = (props) => {
    ...
    const [contextMenuInfo] = useObservableState(
